export const WalletIcon = () => (
  <svg width="24" height="16" viewBox="0 0 24 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_604_1395)">
      ...
      <path d="M2 3.3335V12.6668C2 13.0205 2.14048 13.3596 2.39052 13.6096C2.64057 13.8597 2.97971 14.0002 3.33333 14.0002H13.3333C13.5101 14.0002 13.6797 13.9299 13.8047 13.8049C13.9298 13.6799 14 13.5103 14 13.3335V10.6668" stroke="currentColor" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
    </g>
    <defs>
      <clipPath id="clip0_604_1395">
...
export const CardIcon = () => (
  <svg width="24" height="16" viewBox="0 0 24 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_604_1403)">
      <path d="M13.334 3.3335H2.66732C1.93094 3.3335 1.33398 3.93045 1.33398 4.66683V11.3335C1.33398 12.0699 1.93094 12.6668 2.66732 12.6668H13.334C14.0704 12.6668 14.6673 12.0699 14.6673 11.3335V4.66683C14.6673 3.93045 14.0704 3.3335 13.334 3.3335Z" stroke="currentColor" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M1.33398 6.6665H14.6673" stroke="currentColor" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
    </g>
    <defs>
      <clipPath id="clip0_604_1403">
        <rect width="16" height="16" fill="white"/>
      </clipPath>
    </defs>
  </svg>
...
export const InfoIcon = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M8 11V7.5M8 5V5.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
);

export const ErrorIcon = () => (
  <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="20" cy="20" r="19" stroke="#8B5CF6" strokeWidth="2" fill="transparent"/>
    <path d="M26 14L14 26M14 14L26 26" stroke="#8B5CF6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);